  ...
  return (
    <div style={{ background: '#fff', color: '#1A1A1A', fontFamily: 'inherit', minHeight: '100vh' }}>
      ...
      >
        ...
        <motion.h1 variants={fadeUp} style={{ fontFamily: 'var(--font-fraunces), Fraunces, serif', fontSize: 'clamp(2.8rem, 7vw, 4.5rem)', fontWeight: 800, lineHeight: 1.05, letterSpacing: '-0.03em', marginBottom: '24px' }}>
      ...
      <motion.section style={{ ...col, padding: '72px 24px' }} variants={stagger} {...inView}>
        ...
        <motion.h2 variants={fadeUp} style={{ fontFamily: 'var(--font-fraunces), Fraunces, serif', fontSize: '1.45rem', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: '12px' }}>
      ...
      <motion.section style={{ ...col, padding: '72px 24px' }} variants={stagger} {...inView}>
        ...
        <motion.h2 variants={fadeUp} style={{ fontFamily: 'var(--font-fraunces), Fraunces, serif', fontSize: '1.45rem', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: '40px' }}>
          What Vera tracks
        </motion.h2>
      ...
      <motion.section style={{ ...col, padding: '72px 24px' }} variants={stagger} {...inView}>
        ...
        <motion.h2 variants={fadeUp} style={{ fontFamily: 'var(--font-fraunces), Fraunces, serif', fontSize: '1.45rem', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: '32px' }}>
          Built with
        </motion.h2>
      ...
      >
        ...
        <motion.p variants={fadeUp} style={{ fontFamily: 'var(--font-fraunces), Fraunces, serif', fontSize: '1.25rem', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: '24px' }}>
          Ready to go live?
        </motion.p>
        <motion.div variants={fadeUp}>
          <Link href="/app" style={{
